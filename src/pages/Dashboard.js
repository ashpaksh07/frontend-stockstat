...
const Dashboard = () => {
  ...
  return (
    <Layout>
      ...
      <Box sx={{ display: { xs: "block", sm: "none" }, mr: 1.8 }}>
        <Box
          bgcolor="#f3f3f3"
          sx={{ display: "inline-flex", ml: 1.8, borderRadius: 3 }}
        >
          <div>
            <WorkIcon
              id="workicon"
              sx={{ ml: 1.4, mt: 0.8, color: "#808080", fontSize: "65px" }}
            />
          </div>
          <div className="paraText">
            <p>Total amount added till date:</p>
          ...
          <div className="uploadButtonClass">
            <HashLink to="/#actiondivid">
              <Button sx={{ textTransform: "none" }}>
                <CloudUploadOutlinedIcon sx={{ mr: "5px", fontSize: 18 }} />
                Upload Latest csv
              </Button>
            </HashLink>
          </div>
